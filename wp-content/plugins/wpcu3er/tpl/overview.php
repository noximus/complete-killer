...
<li>
	...
	your CU3ER FREE or PRO account</a>.
	</p>
</li>
<li>
<h4>Create project in cManager</h4>
<p>
<a href="http://getcu3er.com/features/cu3er-manager" target="_blank">cManager</a> is  online application designed to make CU3ER
...
<p>
If you have no access to cManager (available for PRO users) please <a href="http://getcu3er.com/account/login" target="_blank">login</a> to
your CU3ER FREE account and download CU3ER package. Find XML configuration file
in extracted package where paths to the existing images and instructions (settings)
necessary for handling them are defined. By further altering  XML node and
attribute values you will configure CU3ER to match your needs. Learn more about <a href="http://docs.getcu3er.com/xml/" target="_blank">available
XML nodes and attributes.</a>
</p>
</li>
<li>
...
3D magic is awesome.
 ...
 all together make CU3ER amazing content sliding solution.&nbsp;
	...
	<p>Take a look at <a href="http://getcu3er.com" target="_blank">couple of <strong>CU3ER samples</strong></a> or <a href="http://getcu3er.com/demo">try
	<strong>cManager demo</strong></a>.
	</p>
 <p>
 CU3ER PRO  brings you following benefits:
 </p>
	<ul  class="bullets">
		<li>Use CU3ER on Commercial Website</li>
		<li>Full access to <a href="http://getcu3er.com/features/cu3er-manager" target="_blank">cManager</a></li>
		<li>Create up to 20 CU3ER <a href="http://getcu3er.com/features/projects">projects</a> via your account</li>
		<li><a href="http://support.getcu3er.com/entries/253031-starter-templates-new-in-your-pro-account">Starter
				templates</a> as prebuid CU3ER projects</li>
