...
<div class="wrap wrap-CU3ER">
	...
	<h2>Edit &quot;<?php echo $slideshow['name']; ?>&quot; CU3ER
			...
			<input type="button" class="button previewButton add-new-h2" value="Preview" name="browse" rel="<?php echo WP_PLUGIN_URL; ?>/wpcu3er/php/ajaxReq.php?act=preview&id=<?php echo $slideshow['id']; ?>&TB_iframe=true" /> <span class="loading"></span>
	</h2>
	...
	<div class="block">
		...
		<div class="block-inner">
			<div class="transHalf noBorder">
				...
				<div class="textarea">
					<p class="description">This content will be displayed if Flash is not installed or if JS is not enabled:</p>
					<textarea name="settings[content]" id="content"><?php echo ($slideshow['content'] != '') ? $slideshow['content'] : '<p><a href="http://adobe.com/go/getflashplayer" target="_blank"><img src="http://adobe.com/images/shared/download_buttons/get_flash_player.gif" alt="Get Adobe Flash player" /></a></p>'; ?></textarea>
				</div>
				<div class="submit">
	...
	<h3 class="title">Slides and Transitions</h3>
		...
		<input type="button" class="button previewButton" value="Preview" name="browse" rel="<?php echo WP_PLUGIN_URL; ?>/wpcu3er/php/ajaxReq.php?act=preview&id=<?php echo $slideshow['id']; ?>&TB_iframe=true" /> <span class="loading"></span>
